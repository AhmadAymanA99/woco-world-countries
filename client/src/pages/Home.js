...
const Home = () => {
    ...
    const { data: countriesData } = useQuery("featured-countries", () => countriesAPI.getAll({ limit: 6, sortBy: "population", sortOrder: "desc" }));
        ...
        <div className="space-y-16">
            ...
            <section className="text-center py-16">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Discover countries, track your travels, and build memories with WoCo - your personal world exploration companion.</p>
            ...
            <section className="py-16">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Everything You Need to Explore</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">From detailed country information to personal travel tracking, WoCo provides all the tools you need for your world exploration journey.</p>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {features.map(({ icon: Icon, title, description, color, link }) => (
                        <Link key={title} to={link} className="card text-center hover:shadow-lg transition-all hover:scale-105 group">
            ...
            {continentsData && (
                <section className="py-16">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Explore by Continent</h2>
                        <p className="text-gray-600">Discover countries organized by their continents</p>
                    </div>
            ...
            {countriesData && (
                <section className="py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600">Discover some of the most populous countries in the world</p>
                    </div>
